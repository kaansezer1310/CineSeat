...
describe("MoviesPage - Vizyonda / Yakında sekmeleri", () => {
  beforeEach(() => {
    vi.clearAllMocks();
...
describe("MoviesPage — Sıralama ve filtreleme (1.3.3 / 1.3.4)", () => {
  beforeEach(() => {
    vi.clearAllMocks();
    useWatchlist.mockReturnValue({
      watchlist: [],
...
describe("MoviesPage — İzleme listesi vizyona giriş bildirimi (REQ-25 / 1.2.8)", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
